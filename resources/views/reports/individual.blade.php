...
<head>
    ...
    <title>Informe Individual - Resumen Ejecutivo</title>
    <style>
        @page {
            margin: 50px 25px;
...
<body>
    ...
    <main>
        <div class="container mb-3">
            ...
            <br>
            <br>
            <h1 class="title text-center pt-3 pb-2">INFORME DE RESULTADOS DE APTITUD PARA EL PUESTO</h1>
            <br>
                            ...
                            <table class="w-100">
                                <tr>
                                    ...
                                    <td class="w-25 m-0 p-0 text-right">
                                        <p class="result-header-number text-center p-0 m-0">
                                            {{ $data['result']['by_skills'][$skill]['result'] }}</p>
                                    </td>
                            </table>
                        </td>
                    </tr>
        ...
        <p class="new_page"></p>
        <div class="container">
            <h2 class="subtitle">Resultado por Comportamientos</h2>
            @php $i = 1; @endphp
            @forelse ($data['result']['by_behaviors'] as $skill => $results )
                <table class="table_results no-break">
                    <tr>
                        <td class="header color_0{{ $i }}">{{ $skill }}</td>
                    </tr>
                    <tr class="body">
                        <td class="text">
                            <table class="table_results_detailed">
                                <tr>
                                    <td></td>
                                    <td class="header_detailed text-center">NO CUMPLE</td>
                                    <td class="header_detailed text-center">CUMPLE</td>
                                </tr>
                                @php $cont=0; @endphp
                                @foreach ($results as $result)
                                    ...
                                    <tr>
                                        <td
                                            class="text_detailed {{ $cont == count($results) ? 'no_border_detailed' : '' }}">
                                            {{ $result['text'] }}
                                        </td>
                                        <td class="text-center align-middle">
                                            <img class="field"
                                                src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/img/reports/' . ($result['is_present'] == '0' ? 'checked' : 'unchecked') . '.png')) }}">
                                        </td>
                                        <td class="text-center align-middle">
                                            <img class="field"
                                                src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/img/reports/' . ($result['is_present'] == '1' ? 'checked' : 'unchecked') . '.png')) }}">
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
